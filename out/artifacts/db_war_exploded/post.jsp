...
<head>
  ...
  <style>
    * { margin: 0; padding: 0;}
    ...
    .dowebok { position: absolute; left: 50%; top: 45%; width: 430px; height: 580px; margin: -275px 0 0 -215px; border: 0px solid #fff; border-radius: 3px; overflow: hidden;box-shadow: 0px 1px 25px 5px #808080;}
    ...
    @media screen and (max-width: 768px) {
      * { box-sizing: border-box; }
      .dowebok {width: 70%; height: 80%; margin: 0 20px; border: 0; border-radius: 0;position: absolute;top: 15%;left: 12%;}
      .logo { margin: 50px auto;}
      .form-item { width: 100%;}
      .form-item input,.reg-bar { width: 100%;}
      .form-item button{ float: left;}
      #submit{width: 30%;}
      #register{width: 30%; margin-left: 12%;}
      body{border:  5px solid gold}
    }
    @media screen and (max-width: 992px) and (min-width: 768px) {
      .dowebok { position: absolute; width: 50%; height: 80%; margin: 0 30px; border: 0; border-radius: 0;top: 15%;left: 12%; }
      .logo { margin: 50px auto; }
      .form-item { width: 100%; }
    ...
    @media screen and (max-width: 1441px) and (min-width: 992px){
      .dowebok { position: absolute; width: 60%; height: 80%; margin: 0 30px; border: 0; border-radius: 0;top: 17%;left: 25%; }
      .logo { margin: 50px auto; }
